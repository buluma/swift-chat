...
- [下载 Android 版本](https://github.com/aws-samples/swift-chat/releases/download/v1.0.0/SwiftChat.apk)
- [下载 macOS 版本](https://github.com/aws-samples/swift-chat/releases/download/v1.0.0/SwiftChat.dmg)
